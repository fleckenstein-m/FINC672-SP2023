...
filter([:price, :coupon] => ( (x,y)->getBond(x,y)), df)
...
select(df2, [:firm, :askprice, :coupon])
...
select(df2, Not([:issueyear,:bidprice]))
...
let
	...
	date_str = "31-01-2023"
	date = Dates.Date(date_str, "dd-mm-yyyy")
...
issue_dates_str = df3.issuedate

# ╔═╡ 90133060-8d12-47e8-8613-f7f412e51e5a
issue_dates_dt = Dates.Date.(issue_dates_str, "dd-mm-yyyy")

# ╔═╡ 0391e3ca-36f3-40d0-b073-81ff3678834f
df3.issuedate = issue_dates_dt
...
mat_dates_str = df3.maturitydate

# ╔═╡ 8dc61e9c-ba5d-4edc-b2ca-5a7f01b609aa
mat_dates_dt = Dates.Date.(mat_dates_str, "dd-mm-yyyy")

# ╔═╡ 2313ba7a-8471-4c4e-9d8f-453067aee623
df3.maturitydate = mat_dates_dt
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "a66aecaffb1620847a83be6d3d7a8ff5c4be7341"
